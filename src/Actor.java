...
public class Actor {
	...
	public Actor(int sl_no,String business_code, long cust_number, String clear_date, int buisness_year, String doc_id,
			...
			int isOpen, int aging_bucket, int is_deleted) {
		super();
		this.sl_no= sl_no;
		this.business_code = business_code;
		this.cust_number = cust_number;
